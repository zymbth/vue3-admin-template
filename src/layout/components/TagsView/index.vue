<template>
  <div id="tags-view-container" class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper" @scroll="handleScroll" :tag-len="tagLen">
      <router-link
        v-for="(tag, i) in visitedViews"
        :ref="'tag'+i"
        :key="tag.path"
        :class="isActive(tag)?'active':''"
        :to="{ path: tag.path, query: tag.query, fullPath: tag.fullPath, test: tag }"
        tag="span"
    ...
    initTags() {
      ...
      const affixTags = this.affixTags = this.filterAffixTags([{
        ...
        children: [{
          path: 'dashboard',
          name: 'Dashboard',
          meta: { title: 'Dashboard', icon: 'fa-chalkboard', affix: true }
        }]
      }])
